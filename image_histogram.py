...
class Histogram:
    def __init__(self):
        ...
        Button(self.window,text="SEARCH IMAGE",height=2,width=18,bg="gray80").place(x=570,y=40)
        Button(self.window,text="PLOT HISTOGRAM",height=2,width=98,bg="gray87").place(x=10,y=100)
        Button(self.window,text="PLOT CHANNELS HISTOGRAM",height=2,width=98,bg="gray87").place(x=10,y=153)
